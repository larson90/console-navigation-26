...
export type SolutionIllustrationId =
  | 'telegram-n8n'
  | 'jupyter-container'
...
export interface Solution {
  id: string;
  illustrationId: SolutionIllustrationId;
  title: string;
  description: string;
...
export const SOLUTIONS: Solution[] = [
  ...
  },
  {
    ...
    illustrationId: 'jupyter-container',
  ...
  },
  {
    ...
    illustrationId: 'kubernetes-terraform',
  ...
  {
    id: 'helm-yaml-deploy',
    illustrationId: 'helm-yaml-deploy',
  ...
  },
  {
    ...
    illustrationId: 'keda-event-scaling',
